...
#' @usage assignTax(fasta, template, taxonomy, ksize = 8, iters = 100, cutoff = 80,
#' processors = 1, dir.out = "assignTax_out")
#'
#' @param fasta a fasta file of rRNA sequences to be assigned with taxonomies, e.g. a set of sequences picked as the representatives of classified OTUs.
#' @param template a faste file of rRNA reference sequences, e.g. the \code{SILVA_123_SSURef_Nr99_tax_silva_trunc.fasta} file.
#' @param taxonomy a taxonomic path file mapping to the template file, e.g. the \code{taxmap_slv_ssu_123.txt} file mapping to the \code{SILVA_123_SSURef_Nr99_tax_silva_trunc.fasta} file.
...
#' If the classification was performed to a selection of genera (or lower order taxa), we recommend to use the extracted reference sequences by \code{\link{seqExtract}} as the template, accordingly, use the extracted tax file outputted from \code{\link{taxExtract}} as the taxonomy file matched with the given microbes.
...
assignTax = function(fasta, template, taxonomy, ksize = 8, 
